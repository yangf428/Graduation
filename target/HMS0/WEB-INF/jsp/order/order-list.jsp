...
<head>
    ...
    <link rel="shortcut icon" href="/model/ladmin/favicon.ico" type="image/x-icon" />
    <link rel="stylesheet" href="/model/ladmin/css/font.css">
    <link rel="stylesheet" href="/model/ladmin/css/xadmin.css">
    <script src="/model/ladmin/js/jquery.min.js"></script>
    <script type="text/javascript" src="/model/ladmin/lib/layui/layui.js" charset="utf-8"></script>
    <script type="text/javascript" src="/model/ladmin/js/xadmin.js"></script>
    <!-- 让IE8/9支持媒体查询，从而兼容栅格 -->
    <!--[if lt IE 9]>
